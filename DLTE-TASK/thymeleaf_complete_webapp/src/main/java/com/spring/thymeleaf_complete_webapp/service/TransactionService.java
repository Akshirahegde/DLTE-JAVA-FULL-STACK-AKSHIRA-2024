package com.spring.thymeleaf_complete_webapp.service;

import com.spring.thymeleaf_complete_webapp.entity.Transaction;
...
//        else return "No;
    ...
    public List<Transaction> apiFindBySender(String sender){
        List<Transaction> myCards= (List<Transaction>) jdbcTemplate.query("select * from transaction_jdbc where transactionFrom=?",
                new Object[]{sender},
