 ...
 * 
 */
@WebServiceClient(name = "EmployeePortService", targetNamespace = "http://employee.services", wsdlLocation = "file:/C:/DLTE-JAVA-FULL-STACK-AKSHIRA-2024/employee.wsdl.xml")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/DLTE-JAVA-FULL-STACK-AKSHIRA-2024/employee.wsdl.xml");
