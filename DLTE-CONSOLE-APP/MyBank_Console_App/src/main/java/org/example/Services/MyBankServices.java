...
public class MyBankServices {
    ...
    public void Intialize() {
        ...
        Customer user1 = new Customer("Akshira", "akshira123", "Kannur", "akshira@gmail", 987455545L, 4444L, transactionOne);
        Customer user2 = new Customer("Akash", "akash123", "Mangalore", "akash@gmail", 9888888888L, 500L, transactionOne);
        Customer user3 = new Customer("Prashanth", "prashanth123", "Dubai", "prashanth@gmail", 9777777888L, 1000L, transactionOne);
